...
public class PbtCensusDept extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setText("Census Commissioner");
        ...
        jButton2.setText("Director Of Census Operation");

        jButton3.setText("Census Officer");

        jButton4.setText("Principal Census Officer");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PbtDashboard pd = new PbtDashboard();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PbtCensusDept().setVisible(true);
            }
        });
    }
